...
public class ItemController implements CrudController<Item> {
	...
	public Item create() {
		...
		Item item = itemsDAO.create(new Item(Item, Price));
	...
	@Override
	public Item update() {
		LOGGER.info("Please enter the ItemID you would like to update");
		Long ItemID = utils.getLong();
		LOGGER.info("Please enter Item name");
		String Item = utils.getString();
		LOGGER.info("Please enter new price");
		String Price = utils.getString();
		Item item = itemsDAO.update(new Item(ItemID, Item, Price));
